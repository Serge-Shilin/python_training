...
class NewContact(unittest.TestCase):
    ...
    def test_new_contact(self):
        ...
        self.fill_contact_form(wd, Contact(firstname="Сергей", middlename="Сергеевич", lastname="Сергеев", nickname="Серега", address="г. Казань", homephone="11111", mobile="22222",
    ...
    def test_new_contact_empty(self):
        ...
        self.login(wd, username="admin", password="secret")
        self.open_new_contacts(wd)
        self.fill_contact_form(wd, Contact(firstname="", middlename="", lastname="", nickname="", address="", homephone="", mobile="",
