    ...
    def get_contacts_list(self):
        if self.contact_cache is None:
            ...
            for row in wd.find_elements_by_name("entry"):
                ...
                self.contact_cache.append(Contact(lastname=lastname, firstname=firstname, address=address, all_emails_from_home_page=all_emails, id=id, all_phones_from_home_page=all_phones_from_home_page))
